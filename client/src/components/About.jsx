...
export default function About() {
  return (
    ...
    <br></br> <br></br>
      ...
      <p>In her work, Melissa explored the tension between contrast and harmony, balancing curves and clean lines to produce beautifully unexpected shape combinations. She maintained a simple palette of black, white, and earth tones to challenge herself to innovate with form, experimenting with dimension and configuration to create distinctive pieces that could speak for themselves with little addition of color.</p> 
      </div>
